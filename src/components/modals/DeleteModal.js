...
import { deleteActivity } from "../../core/Activity";
...
const DeleteModal = (props, ref) => {
  ...
  const { content, activityId } = props;
  const show = () => {
    setShowModal(true);
  };
              ...
              <div className="relative w-auto my-6 mx-auto max-w-3xl">
                ...
                <div className="rounded-lg shadow-all relative flex flex-col w-full bg-white">
                  ...
                  <div className="flex pb-6 justify-around">
                    ...
                    <button
                      className="bg-green-pin rounded-md font-semibold text-white uppercase px-6 py-2 text-sm hover:bg-opacity-40 ease-linear transition-all duration-300"
                      type="button"
                      onClick={() => {
